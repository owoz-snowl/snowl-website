...
const i18n={
  en:{
    ...
    adv_delivery_desc:"Efficient production and logistics ensure timely delivery to maritime customers worldwide.",
    adv_delivery_title:"Fast Delivery",
    adv_desc:"Adv Desc",
    adv_patent_desc:"Adv Patent Desc",
    adv_patent_title:"80+ Patents",
    adv_quality_desc:"ISO-certified manufacturing with rigorous quality control at every stage.",
    adv_quality_title:"Premium Quality",
    adv_support_desc:"Dedicated sales and technical support for customers in 50+ countries.",
    adv_support_title:"Global Support",
    adv_tag:"Why SNOWL",
    adv_title:"Adv Title",
    cat1_title:"OWOZ Fastener",
    cat2_title:"Snap Fastener",
    cat3_title:"Turn Button",
    cat4_title:"Nylon Button",
    cat5_title:"Installation Tool",
    cat6_title:"Marine Buckles",
    ...
    hero_badge:"Marine Hardware Excellence",
    ...
    nav_videos:"Videos",
    news1_desc:"SNOWL will showcase its complete product range at METSTRADE in Amsterdam this November.",
    news1_title:"METSTRADE 2026",
    news2_desc:"Introducing our new SS316 marine snap fastener series with enhanced saltwater resistance.",
    news2_title:"SS316 Series Launch",
    news3_desc:"How SNOWL is leading the industry toward eco-friendly manufacturing and materials.",
    ...
    news_hero_title:"News & Industry Updates",
    news_hero_title2:"Industry Insights",
    ...
    nylon_tag:"Nylon Buttons",
    owoz_tag:"OWOZ Fastener",
    phone_label:"Phone",
    phone_value:"+86-757-87768348",
    proc_desc:"Simple and efficient ordering process for global maritime customers.",
    proc_tag:"How to Order",
    proc_title:"How to Order",
    prod1_desc:"The original OWOZ snap-lock fastener. Quick release, secure lock. Ideal for heavy-duty marine applications.",
    prod1_title:"OWOZ Quick-Release Fastener",
    prod2_desc:"Premium stainless steel snap fasteners with superior corrosion resistance for prolonged saltwater exposure.",
    prod2_title:"SS316 Marine Snap Fastener",
    prod3_desc:"Precision-engineered turn buttons for yacht decks and marine canvas installations.",
    prod3_title:"Turn Button Deck Fastener",
    ...
    prod5_desc:"Professional-grade installation and removal tools for all SNOWL fastener types.",
    ...
    prod_hero_desc:"Explore our complete range of precision marine hardware — OWOZ fasteners, snap buttons, turn buttons, and deck accessories.",
    prod_hero_title:"Product Catalog",
    prod_hero_title2:"Product Overview",
    ...
    vid_placeholder_footer:"More videos on our YouTube channel.",
  ...
  zh:{{
    ...
    cat6_title:"船用扣件",
    contact_addr:"中国广东佛山",
    contact_desc:"无论您需要定制船舶解决方案还是标准产品——我们都在这里帮您。",
    ...
    f_prod:"产品",
    footer_brand_desc:"SNOWL香港有限公司 — 精密船舶紧固件制造商，始于1995年。",
    form_company:"公司名称",
    form_country:"国家",
    form_email:"电子邮箱",
    form_message:"您的留言",
    ...
    prod1_title:"OWOZ快拨紧固件",
    prod2_desc:"Prod2 Desc",
    prod2_title:"SS316船用金属按扣",
    prod3_desc:"Prod3 Desc",
    prod3_title:"旋转扣甲板紧固件",
